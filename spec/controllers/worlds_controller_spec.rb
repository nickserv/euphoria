  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved world as @world" do
        ...
        post :create, {:world => { "name" => "invalid value" }}, valid_session
        assigns(:world).should be_a_new(World)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested world" do
        ...
        World.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => world.to_param, :world => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the world as @world" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        World.any_instance.stub(:save).and_return(false)
        put :update, {:id => world.to_param, :world => { "name" => "invalid value" }}, valid_session
        assigns(:world).should eq(world)
      end
