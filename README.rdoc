= Euphoria
{<img src="https://magnum.travis-ci.com/thenickperson/euphoria.png?token=2YpiqRLGxdsv1ho7eXeu&branch=simple-form" alt="Build Status" />}[https://magnum.travis-ci.com/thenickperson/euphoria]
